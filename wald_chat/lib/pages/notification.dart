...
import 'package:wald_chat/components/notification_stream_wrapper.dart';
import 'package:wald_chat/models/notification.dart';
import 'package:wald_chat/utils/firebase.dart';
import 'package:wald_chat/widgets/notification_items.dart';
...
class _ActivitiesState extends State<Activities> {
  ...
  deleteAllItems() async {
    ...
    QuerySnapshot notificationSnap = await notificationRef
        ...
        .collection('notifications')
        .get();
    for (var doc in notificationSnap.docs) {
      if (doc.exists) {
