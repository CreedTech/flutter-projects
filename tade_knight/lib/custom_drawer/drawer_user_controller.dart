...
class _DrawerUserControllerState extends State<DrawerUserController>
  ...
  void initState() {
    ...
    iconAnimationController =
        AnimationController(duration: const Duration(), vsync: this);
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          // used width as screen width and add drawerWidth (from navigation screen)
          child: Row(
            children: [
              SizedBox(
                width: widget.drawerWidth,
                // divided first drawer Width with homeDrawer and second full screen Width with all home screen, called screen view
                height: MediaQuery.of(context).size.height,
                child: AnimatedBuilder(
                  animation: iconAnimationController,
                  builder: (BuildContext context, _) {
                    return Transform(
                      // transform used for the stable drawer, not needed to move with scroll view
